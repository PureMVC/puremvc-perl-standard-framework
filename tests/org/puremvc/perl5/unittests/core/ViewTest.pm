package org::puremvc::perl5::unittests::core::ViewTest;
...
use org::puremvc::perl5::unittests::core::ViewTestMediator;
use org::puremvc::perl5::unittests::core::ViewTestMediator2;
use org::puremvc::perl5::unittests::core::ViewTestMediator3;
use org::puremvc::perl5::unittests::core::ViewTestMediator4;
use org::puremvc::perl5::unittests::core::ViewTestMediator5;
use org::puremvc::perl5::unittests::core::ViewTestMediator6;

use constant NOTE1 => 'org::puremvc::perl5::unittests::core::ViewTest::note1';
use constant NOTE2 => 'org::puremvc::perl5::unittests::core::ViewTest::note2';
use constant NOTE3 => 'org::puremvc::perl5::unittests::core::ViewTest::note3';
use constant NOTE4 => 'org::puremvc::perl5::unittests::core::ViewTest::note4';
use constant NOTE5 => 'org::puremvc::perl5::unittests::core::ViewTest::note5';
use constant NOTE6 => 'org::puremvc::perl5::unittests::core::ViewTest::note6';

BEGIN { print "############### View tests\n"; }

BEGIN { use_ok( 'org::puremvc::perl5::core::View' ); }
require_ok( 'org::puremvc::perl5::core::View' );
...
sub testGetInstance {
  ...
  isa_ok($view, "org::puremvc::perl5::core::View");
}
...
sub testRegisterAndNotifyObserver {
  ...
  my $observer = org::puremvc::perl5::patterns::observer::Observer->new("viewTestMethod", __PACKAGE__);
  
  $view->registerObserver("ViewTestNote", $observer);
  
  my $notification = org::puremvc::perl5::patterns::observer::Notification->new("ViewTestNote", 2);
...
sub testRegisterAndRetrieveMediator {
  ...
  my $view = org::puremvc::perl5::core::View->getInstance();
  my $testmediator = org::puremvc::perl5::unittests::core::ViewTestMediator->new(__PACKAGE__);
  
  $view->registerMediator($testmediator);
  
  my $mediator = $view->retrieveMediator(org::puremvc::perl5::unittests::core::ViewTestMediator::NAME);
...
sub testOnRegisterAndOnRemove {
  ...
  my $view = org::puremvc::perl5::core::View->getInstance();
  my $testmediator = org::puremvc::perl5::unittests::core::ViewTestMediator4->new(__PACKAGE__);
  
  $view->registerMediator($testmediator);
  is($on_register_called, 1, 'Expecting $on_register_called to be 1');
  
  $view->removeMediator(org::puremvc::perl5::unittests::core::ViewTestMediator4::NAME);
...
sub testSuccessiveRegisterAndRemoveMediator {
  ...
  $view->removeMediator(org::puremvc::perl5::unittests::core::ViewTestMediator::NAME);
  is($view->retrieveMediator(org::puremvc::perl5::unittests::core::ViewTestMediator::NAME), undef, 'Expecting $view->retrieveMediator(org::puremvc::perl5::unittests::core::ViewTestMediator::NAME) to be undef');
  # Testing removeMediator again to see whether it crashes
  is($view->removeMediator(org::puremvc::perl5::unittests::core::ViewTestMediator::NAME), undef, 'Expecting $view->removeMediator(org::puremvc::perl5::unittests::core::ViewTestMediator::NAME) to be undef');

  $view->registerMediator($testmediator);
  is($view->retrieveMediator(org::puremvc::perl5::unittests::core::ViewTestMediator::NAME), $testmediator, 'Expecting $view->retrieveMediator(org::puremvc::perl5::unittests::core::ViewTestMediator::NAME) to be $testmediator');
...
sub testRemoveMediatorAndSubsequentNotify {
  ...
  my $view = org::puremvc::perl5::core::View->getInstance();
  my $testmediator = org::puremvc::perl5::unittests::core::ViewTestMediator2->new(__PACKAGE__);
  my $mediator_name = org::puremvc::perl5::unittests::core::ViewTestMediator2::NAME;
  
  $view->registerMediator($testmediator);
  
  $view->notifyObservers(org::puremvc::perl5::patterns::observer::Notification->new(NOTE1) );
  is($lastNotification, NOTE1, 'Expecting $lastNotification to be NOTE1');
  
  $view->notifyObservers(org::puremvc::perl5::patterns::observer::Notification->new(NOTE2) );
...
sub testRemoveOneOfTwoMediatorsAndSubsequentNotify {
  ...
  my $view = org::puremvc::perl5::core::View->getInstance();
  my $testmediator2 = org::puremvc::perl5::unittests::core::ViewTestMediator2->new(__PACKAGE__);
  my $testmediator3 = org::puremvc::perl5::unittests::core::ViewTestMediator3->new(__PACKAGE__);
  my $mediator_name2 = org::puremvc::perl5::unittests::core::ViewTestMediator2::NAME;
  my $mediator_name3 = org::puremvc::perl5::unittests::core::ViewTestMediator3::NAME;
  ...
  $view->notifyObservers(org::puremvc::perl5::patterns::observer::Notification->new(NOTE3) );
...
sub testMediatorReregistration {
  ...
  my $view = org::puremvc::perl5::core::View->getInstance();
  my $testmediator1 = org::puremvc::perl5::unittests::core::ViewTestMediator5->new(__PACKAGE__);
  my $testmediator2 = org::puremvc::perl5::unittests::core::ViewTestMediator5->new(__PACKAGE__);
  my $mediator_name = org::puremvc::perl5::unittests::core::ViewTestMediator5::NAME;
  
  $view->registerMediator($testmediator1);
  $view->registerMediator($testmediator2);
  
  $view->notifyObservers(org::puremvc::perl5::patterns::observer::Notification->new(NOTE5) );
...
sub testModifyObserverListDuringNotification {
  ...
  my $view = org::puremvc::perl5::core::View->getInstance();
  my $testmediator1 = org::puremvc::perl5::unittests::core::ViewTestMediator6->new("ViewTestMediator61", __PACKAGE__);
  my $testmediator2 = org::puremvc::perl5::unittests::core::ViewTestMediator6->new("ViewTestMediator62", __PACKAGE__);
  my $testmediator3 = org::puremvc::perl5::unittests::core::ViewTestMediator6->new("ViewTestMediator63", __PACKAGE__);
  my $testmediator4 = org::puremvc::perl5::unittests::core::ViewTestMediator6->new("ViewTestMediator64", __PACKAGE__);
  my $testmediator5 = org::puremvc::perl5::unittests::core::ViewTestMediator6->new("ViewTestMediator65", __PACKAGE__);
  my $testmediator6 = org::puremvc::perl5::unittests::core::ViewTestMediator6->new("ViewTestMediator66", __PACKAGE__);
  my $testmediator7 = org::puremvc::perl5::unittests::core::ViewTestMediator6->new("ViewTestMediator67", __PACKAGE__);
  my $testmediator8 = org::puremvc::perl5::unittests::core::ViewTestMediator6->new("ViewTestMediator68", __PACKAGE__);
  ...
  $view->notifyObservers(org::puremvc::perl5::patterns::observer::Notification->new(NOTE6) );
...
sub cleanup {
  ...
  $view->removeMediator(org::puremvc::perl5::unittests::core::ViewTestMediator::NAME);
  $view->removeMediator("ViewTestMediator2");
  $view->removeMediator("ViewTestMediator3");
