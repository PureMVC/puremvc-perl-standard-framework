package org::puremvc::perl5::unittests::core::ModelTest;
...
use org::puremvc::perl5::unittests::core::ModelTestProxy;

BEGIN { print "############### Model tests\n"; }

BEGIN { use_ok( 'org::puremvc::perl5::core::Model' ); }
require_ok( 'org::puremvc::perl5::core::Model' );
...
sub testGetInstance {
  ...
  my $model = org::puremvc::perl5::core::Model->getInstance();
  isa_ok($model, "org::puremvc::perl5::core::Model");
}
...
sub testOnRegisterAndOnRemove {
  ...
  my $model = org::puremvc::perl5::core::Model->getInstance();
  my $proxy = org::puremvc::perl5::unittests::core::ModelTestProxy->new();
  
  $model->registerProxy($proxy);
  is($proxy->getData(), org::puremvc::perl5::unittests::core::ModelTestProxy::ON_REGISTER_CALLED, 'Expecting $proxy->getData() to be ' . org::puremvc::perl5::unittests::core::ModelTestProxy::ON_REGISTER_CALLED);

  $model->removeProxy(org::puremvc::perl5::unittests::core::ModelTestProxy::NAME);
  is($proxy->getData(), org::puremvc::perl5::unittests::core::ModelTestProxy::ON_REMOVE_CALLED, 'Expecting $proxy->getData() to be ' . org::puremvc::perl5::unittests::core::ModelTestProxy::ON_REMOVE_CALLED);
