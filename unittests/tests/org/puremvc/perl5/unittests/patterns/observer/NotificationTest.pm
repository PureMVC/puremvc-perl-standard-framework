package org::puremvc::perl5::unittests::patterns::notification::NotificationTest;
...
BEGIN { use_ok( 'org::puremvc::perl5::patterns::observer::Notification' ); }
require_ok( 'org::puremvc::perl5::patterns::observer::Notification' );
...
sub testConstructor {
  ...
  my $notification = org::puremvc::perl5::patterns::observer::Notification->new("NotificationTestNote", 5, "note_type");
  
  is(defined $notification, 1, 'Expecting $notification to be defined');
  isa_ok($notification, 'org::puremvc::perl5::patterns::observer::Notification');
...
sub testBodyAccessors {
  ...
  my $notification = org::puremvc::perl5::patterns::observer::Notification->new();
...
sub testToString {
  ...
  my $notification = org::puremvc::perl5::patterns::observer::Notification->new("NotificationTestNote", [1,2,3], "note_type");
  my $dump = '$VAR1 = bless( {\'_name\' => \'NotificationTestNote\',\'_type\' => \'note_type\',\'_body\' => [1,2,3]}, \'org::puremvc::perl5::patterns::observer::Notification\' );';
