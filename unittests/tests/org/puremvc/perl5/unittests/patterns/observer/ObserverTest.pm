package org::puremvc::perl5::unittests::patterns::observer::ObserverTest;
...
BEGIN { use_ok( 'org::puremvc::perl5::patterns::observer::Observer' ); }
require_ok( 'org::puremvc::perl5::patterns::observer::Observer' );
...
sub testConstructor {
  ...
  my $observer = org::puremvc::perl5::patterns::observer::Observer->new("testMethod", __PACKAGE__);

  my $notification = org::puremvc::perl5::patterns::observer::Notification->new("ObserverTestNote", 5);
...
sub testObserverAccessors {
  ...
  my $observer = org::puremvc::perl5::patterns::observer::Observer->new(undef, undef);
  $observer->setNotifyMethod("testMethod");
  $observer->setNotifyContext(__PACKAGE__);

  my $notification = org::puremvc::perl5::patterns::observer::Notification->new("ObserverTestNote", 10);
...
sub testCompareNotifyContext {
  ...
  my $context = {};
  my $observer = org::puremvc::perl5::patterns::observer::Observer->new("testMethod", $context);
  my $object = {};
